...
# FIXME minio volume 정책이 필요하면 소스 살리세요!
# mc_admin = MinioAdmin("local")
# mc_admin.bucket_quota_set(bucket=settings.MINIO_IMAGE_BUCKET, hard=settings.MINIO_LIMIT_HARD_SIZE)
