...
class Settings(BaseSettings):
    ...
    BLANK_IMAGE: str = \
    """
    Qk1+AAAAAAAAAHoAAABsAAAAAQAAAAEAAAABABgAAAAAAAQAAAAjLgAAIy4AAAAAAAAAAAAAQkdScwAA
    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIAAAAAAAAAAAAAAAAAAAD///8A
    """
