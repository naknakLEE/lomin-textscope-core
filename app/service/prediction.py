...
from app.utils.utils import load_image2base64, basic_time_formatter, get_company_group_prefix, cal_time_elapsed_seconds
...
def get_all_prediction(session: Session) -> JSONResponse:
    response = dict()
    response_log = dict()
