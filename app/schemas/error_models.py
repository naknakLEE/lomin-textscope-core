...
ErrorCode: Dict[int, Tuple[int, Error]] = {
    ...
    2107: (404, Error(2107, "doc_type_idx에 해당하는 문서 종류가 존재하지 않습니다")),
    ...
    2509: (404, Error(2509, "사용자 권한 정보가 없습니다")),
    2510: (404, Error(2510, "dept_id에 해당하는 부서에 대한 권한이 없습니다")),
    2511: (405, Error(2511, "document_id에 해당하는 문서는 다른 사용자가 이미 검수 중입니다")),
