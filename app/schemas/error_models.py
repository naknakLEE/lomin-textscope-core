...
ErrorCode: Dict[int, Tuple[int, Error]] = {
    ...
    4501: (500, Error(4501, "user 정보를 저장하는 중 에러가 발생했습니다")),
    4502: (500, Error(4502, "user 정보를 가져오는 중 에러가 발생했습니다")),
    4601: (500, Error(4601, "page 정보를 저장하는 중 에러가 발생했습니다")),
    4602: (500, Error(4602, "page 정보를 가져오는 중 에러가 발생했습니다")),
    4701: (500, Error(4701, "추론 정보를 저장하는 중 에러가 발생했습니다")),
    4702: (500, Error(4702, "추론 정보를 가져오는 중 에러가 발생했습니다")),
