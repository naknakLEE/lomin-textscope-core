...
def get_user_group_policy(
    ...
    try:
        ...
        user_group_policy_result: List[Tuple[schema.UserGroup, schema.GroupInfo, schema.GroupPolicy]]
        query = session.query(schema.UserGroup, schema.GroupInfo, schema.GroupPolicy) \
            .filter(schema.UserGroup.user_email == user_email) \
            .filter(schema.GroupInfo.group_code == schema.UserGroup.group_code, schema.GroupPolicy.group_code == schema.GroupInfo.group_code) \
        ...
        user_group_policy_result: List[schema.UserGroup] = user_group_policy_result
