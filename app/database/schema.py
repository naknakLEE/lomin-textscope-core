...
class DocumentInfo(Base, BaseMixin):
    ...
    doc_type_idxs = Column(MutableDict.as_mutable(JSON), comment='문서에 포함된 문서 종류 정보')
    doc_type_idx = Column(ARRAY(Integer, zero_indexes=True), comment="문서에 포함된 문서 종류(소분류) 인덱스 리스트")
