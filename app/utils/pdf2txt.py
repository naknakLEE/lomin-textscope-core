...
class Pdf2Image():
    def __init__(self, data_dir: Optional[str] = None):
        ...
        self.load_lexicon()
        self.font_files = [_ for _ in os.listdir(os.path.join(self.data_dir, 'fonts')) if os.path.splitext(os.path.basename(_))[-1].lower() == '.ttf']
    ...
    def load_lexicon(self):
        ...
        for idx, lexicon in enumerate(glob.glob(os.path.join(self.data_dir, 'lexicons', '*.txt'))):
            all_texts = list()
    ...
    def read_xml(self, xml_path, page_num, page_size):
        ...
        bboxes = self.resize_bbox(bboxes, w_ratio=page_size[0]/width, h_ratio=page_size[1]/height)
...
pdf2txt = Pdf2Image("/workspace/inference_server/assets")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", required=False, type=str, default="/tmp/temp.jpg")
