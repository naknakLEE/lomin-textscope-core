...
from app.service.document import (
    ...
    delete_document_list as delete_document_list_service,
    get_document_list_sequence as get_document_list_sequence_service,
    get_filter_user_uploader as get_filter_user_uploader_service,
    get_filter_user_inspecter as get_filter_user_inspecter_service,
    get_doc_type_kv_list as get_doc_type_kv_list_service,
    get_document_preview as get_document_preview_service,
    )
...
def get_document_preview(
    ...
    """
    return get_document_preview_service(
...
def get_doc_type_kv_list(
    ...
    """
    return get_doc_type_kv_list_service(
        doc_type = doc_type,
        current_user = current_user,
        session = session
    )
...
def get_filter_user_inspecter(
    ...
    """
    return get_filter_user_inspecter_service(
        user_team = user_team,
        current_user = current_user,
        session = session
    )
...
def get_filter_user_uploader(
    ...
    """
    return get_filter_user_uploader_service(
        user_team = user_team,
        current_user = current_user,
        session = session
    )
...
async def get_document_list_sequence(
    ...
    """
    return get_document_list_sequence_service(
        document_id = document_id,
        current_user = current_user,
        session = session
    )    
...
async def delete_document_list(
    ...
    """
        업무 리스트 삭제
    """
    return delete_document_list_service(
        request = request,
        document_id = document_id,
        current_user = current_user,
        session = session
