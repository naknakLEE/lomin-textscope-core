...
def main():
    ...
    parser.add_option(
        ...
        default=1,
        help=("The length of the random names that will be used when obfuscating " "identifiers."),
        metavar="1",
    )
    parser.add_option(
        "--nonlatin",
    ...
    parser.add_option(
        ...
        default=None,
        help=(
            "Prepend the text in this file to the top of our output.  " "e.g. A copyright notice."
        ),
        metavar="<file path>",
    )
