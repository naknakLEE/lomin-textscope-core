...
class TestDirStructureValidation:
    ...
    def generate_fake_dirs(
        self,
        exist_file_under_root_dir=False,
        empty_root_dirs=False,
        exist_sub_dir=False,
        empty_sub_dir=False,
        exist_unsupporeted_ext=False,
    ):
