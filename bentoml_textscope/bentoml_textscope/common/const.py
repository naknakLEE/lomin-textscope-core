...
class Settings(BaseSettings):
    ...
    # FIND ROTATED ANGLE CONFIG
    ROTATE_IMAGE_MIN_SIZE: int = 640
    ROTATE_IMAGE_MAX_SIZE: int = 960
    MEDIANBLUR_PATCH_SIZE: int = 3
    ADAPTIVETHRESHOLD_PATCH_SIZE: int = 5

    # DETECTION PREPROCESSING CONFIG
    DETECTION_IMAGE_MIN_SIZE: int = 3000
    DETECTION_IMAGE_MAX_SIZE: int = 3200
    ...
    OCR_DEBUGGING: str = "profiling"  # profiling or base
